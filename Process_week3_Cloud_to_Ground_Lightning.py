# Copy of Cloud_to_Ground_Lightning.py for process week 3
...
def animate_flower():
    ...
    for ring in range(rings):
        ...
        for i in range(dots_per_ring[ring]):
            ...
            # Flower petal equation
            r = base_radius * (1 + petal_depth * np.sin(lobes * angle))
            # Add some random jitter for natural look
